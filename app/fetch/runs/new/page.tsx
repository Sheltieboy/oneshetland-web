...
import { getDriverProfile, isApprovedDriver, isBankConnected } from "@/lib/fetch-data.server";
import { RunComposer } from "@/components/fetch/RunComposer";

export const dynamic = "force-dynamic";
export const metadata = { title: "Create a run · Fetch · OneShetland" };
...
export default async function NewRunPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-5 py-10 sm:py-14">
      ...
      <RunComposer canCreate={isBankConnected(dp)} />
    </div>
  );
}
