...
export const metadata = { title: "My shift applications" };
    ...
    <div className="mx-auto max-w-3xl px-5 py-10 sm:py-14">
      ...
      <div className="mt-8 space-y-4">
        {!account ? (
          ...
          <EmptyState icon="⚡" title="No shift applications yet" body="Apply for a shift and it'll appear here." cta={{ label: "Browse shifts", href: "/jobs?tab=shifts", color: SHIFTS }} />
        ) : (
