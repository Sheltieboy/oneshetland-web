...
export async function generateMetadata({ params }: { params: Promise<{ id: string }> }) {
  ...
  return { title: m ? `${m.title || m.place_name || "A story"} · Aald Memories` : "Aald Memories" };
}
      ...
      <section className="relative isolate overflow-hidden text-paper" style={{ background: MEMORIES }}>
        ...
        <div className="relative mx-auto max-w-3xl px-5 py-12 sm:py-14">
          <div className="flex items-center justify-between gap-3">
            <Link href="/memories" className="text-sm font-semibold text-paper/85 hover:text-paper">← Aald Memories</Link>
