...
export default async function ManageBusinessPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const tiles: Tile[] = [
    ...
    { href: `${base}/analytics`, icon: "📊", title: "Analytics", desc: "Views, engagement & revenue", built: true },
    ...
    { href: `${base}/leads`, icon: "🔧", title: "Job leads", desc: "Folk looking for a tradesperson · say what you cover and when", built: true },
