...
export const metadata = { title: "Aald Memories", description: "A living map of the islands — pin a place, tell its story, leave a photo or a voice note." };
    ...
    <>
      ...
      <section className="relative isolate overflow-hidden text-paper" style={{ background: MEMORIES }}>
        ...
        <div className="relative mx-auto max-w-6xl px-5 py-12 sm:py-16">
          ...
          <h1 className="mt-2 font-display text-5xl font-bold sm:text-6xl">Aald Memories</h1>
